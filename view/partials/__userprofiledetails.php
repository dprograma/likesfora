<div class="card customshadow p-3">
    ...
    <hr />
    <?php if($work){; ?>
    <div class="card-text p-2 m-2"><i class="fas fa-briefcase mr-2"></i> Worked at <strong><?php echo $work; ?></strong></div><?php }; ?>
    <?php if($work1){; ?>
    ...
    <?php if($education){; ?>
    <div class="card-text p-2 m-2"><i class="fas fa-graduation-cap mr-2"></i> Went to <strong><?php echo $education; ?></strong></div><?php }; ?>
    <?php if($education1){; ?>
